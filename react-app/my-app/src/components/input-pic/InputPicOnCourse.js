...
export const InputPicOnCourse = (props) => {
  return (
    <div className={classes["hor-input"]}>
      ...
      <div className={classes["input-file-wrapper"]}>
        <label
          ...
          htmlFor={`img-course-des-input-${props.descriptionIndex}-${props.imageIndex}`}
        >
          <svg
        ...
        <input
          type="file"
          id={`img-course-des-input-${props.descriptionIndex}-${props.imageIndex}`}
          name="img-course"
          accept=".jpg,.jpeg,.png"
          onChange={(e) => {
            props.onSelect(
